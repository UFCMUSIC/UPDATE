...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","ll_DOREMON_ll")
# --------------------------------------------------------
...
OWNER_ID = int(getenv("OWNER_ID", 8184370372))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/UFCMUSIC/UPDATE",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://solo.to/unoffical")
SUPPORT_CHAT = getenv("SUPPORT_CHAT","https://solo.to/unoffical")
